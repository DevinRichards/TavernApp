...
def upgrade():
    ...
    op.create_table('direct_messagess',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('content', sa.String(length=255), nullable=False),
    sa.Column('senderId', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['receiverId'], ['users.id'], name='fk_direct_messagess_receiverId_users'),
    sa.ForeignKeyConstraint(['senderId'], ['users.id'], name='fk_direct_messagess_senderId_users'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('direct_messagess')
